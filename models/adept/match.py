...
class Matcher(object):
    def __init__(self, cfg):
        ...
        self.base_penalty_high = matcher_cfg.BASE_PENALTY_HIGH
    ...
    def _get_match_matrix(self, belief, observation):
        ...
        base_penalty = self.base_penalty if n_belief_objects <= 8 else self.base_penalty_high
        matrix = [[base_penalty] * n for _ in range(n)]
